...
public class ReplaceEmailTemplateTokens extends CustomJavaAction<java.lang.Boolean>
{
	...
	private email_connector.proxies.EmailMessage email;
	...
	{
		this.email = this.__email == null ? null : email_connector.proxies.EmailMessage.initialize(getContext(), __email);
